                ...
                <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                  <form action="" method="post">
                    ...
                    <div class="d-flex justify-content-center mx-4 mb-3 mb-lg-4">
                      <button class="btn btn-primary" type="submit" value="Sign in" name="signIn" class="btn btn-warning btn-lg text-light my-2 py-3" style="width: 100%; height: 60px; border-radius: 30px; font-weight: 600; background-color: #ffc107;">Sign In</button>
                    </div>
<center>
                    <br>
                    <p><a href="../../sign/admin/login_admin.php"  class="btn btn-warning  text-light ms-2 py-3" style="width: 90%; height: 60px; border-radius: 30px; font-weight: 500; background-color: #ffc107;">Admin</a></p>
