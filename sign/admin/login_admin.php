      ...
      <div class="row d-flex align-items-center justify-content-center h-100">
        ...
        <div class="col-md-7 col-lg-5 col-xl-5 offset-xl-1">
          <form action="" method="post">
            <p class="text-center h1 fw-bold mb-4 mx-1 mx-md-3 mt-3">Login Admin </p>
            <!-- Email input -->
            ...
            <div class="d-flex justify-content-center mx-4 mb-3 mb-lg-4">
              <button class="btn btn-primary" type="submit" value="Sign in" name="btn-login" class="btn btn-warning btn-lg text-light my-2 py-3" style="width: 100%; height: 60px; border-radius: 30px; font-weight: 600; background-color: #ffc107;">Sign In</button>
            </div>
            <center>
